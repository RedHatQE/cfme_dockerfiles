...
RUN yum install -y x11vnc wget fluxbox bzip2 xterm nano xorg-x11-server-Xvfb net-tools dbus-glib gtk2 java-1.8.0-openjdk flash-plugin nspluginwrapper alsa-plugins-pulseaudio libcurl unzip xdg-utils redhat-lsb GConf2 libXScrnSaver xorg-x11-fonts-ISO8859-1-75dpi xorg-x11-fonts-ISO8859-1-100dpi dejavu* openssh-server
